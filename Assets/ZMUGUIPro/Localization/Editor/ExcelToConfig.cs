...
public class ExcelToConfig
{
    ...
    [MenuItem("Tools/生成Excel多语言配置")]
    static void GeneratorLocalization()
    {
        DataSet resultSet = LoadExcel(ExcelLaodPath + "翻译文档.xlsx");
    ...
    public static DataSet LoadExcel(string excelFile)
    {
